...
void CellEnergyCoarsening2D::getValue(const Model &model, PerCellValue &cell_value) const {
    ...
    cell_value = (area / site_size_target - 1.0).square() * weights[AREA] +
...
void CellEnergyCoarsening2D::makeConfigMenu() {
