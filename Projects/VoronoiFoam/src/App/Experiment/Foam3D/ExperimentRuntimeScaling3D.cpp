...
void ExperimentRuntimeScaling3D::setup(FoamSubApp* foam_sub_app) {
    ...
    auto energy = std::dynamic_pointer_cast<CellEnergy3D>(
        foam_sub_app->energy_selector.second[foam_sub_app->energy_selector.first].second);
    energy->weights[VOLUME] = 1.0;
    energy->weights[SURFACE_TARGET] = 0.0;
    energy->weights[SURFACE_MINIMIZATION] = 0.0;
...
void ExperimentRuntimeScaling3D::loop(FoamSubApp* foam_sub_app, Optimization::OptimizationStatus optimization_status) {
