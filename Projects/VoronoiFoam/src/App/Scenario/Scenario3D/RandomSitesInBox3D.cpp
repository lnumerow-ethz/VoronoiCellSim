...
bool RandomSitesInBox3D::generateScenario(ModelDefinition &model_definition,
                                          DegreesOfFreedom &degrees_of_freedom) const {
    model_definition.boundary_generator = std::make_shared<BoundaryGeneratorBox3D>();
...
void RandomSitesInBox3D::makeConfigMenu() {
